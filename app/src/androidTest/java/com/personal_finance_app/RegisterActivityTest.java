...
public class RegisterActivityTest {
    ...
    public void loginActivityTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.email),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("user1@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction materialCheckBox = onView(
                allOf(withId(R.id.termsCheckbox), withText("I�ve read and agree to the"),
                        childAtPosition(
                                allOf(withId(R.id.main),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.confirmPassword), withText("123456"),
                        childAtPosition(
                                allOf(withId(R.id.main),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatImageButton = onView(
                allOf(withId(R.id.registerButton), withContentDescription("REGISTER"),
                        childAtPosition(
                                allOf(withId(R.id.main),
                                        childAtPosition(
                                                withId(android.R.id.content),
